...
public class MenuEns extends JFrame {
    ...
    public MenuEns() {
        ...
        ImagePanel mainPanel = new ImagePanel(new ImageIcon("C:\\Users\\User\\Desktop\\background.png").getImage());
